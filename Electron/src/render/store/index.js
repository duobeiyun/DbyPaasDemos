...
const Store = BaseType.named('Store').props({
  ...
  get currentCameraDeviceInfo() {
    return _.find(self.cameraDevices.toJSON(), ['name', self.currentCameraDeviceName])
  },
  get currentCameraDeviceIndex() {
    return _.findIndex(self.cameraDevices.toJSON(), ['name', self.currentCameraDeviceName])
  },
  get currentMicDeviceInfo() {
    return _.find(self.micDevices.toJSON(), self.currentMicDeviceName)
  },
  get currentMicDeviceIndex() {
    return _.indexOf(self.micDevices.toJSON(), self.currentMicDeviceName)
  },
